...
SECRET_KEY = 'django-insecure-e3m51m_-+%8j+%jrec$opqp6y8hx2!#_%uka=9gq+l0!+!qd-3'
...
SIMPLE_JWT = {
    # modify this to add or extract time of token expiration
...
AUTH_USER_MODEL = 'signing.Client'
